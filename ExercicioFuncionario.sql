	...
	SELECT COUNT(*) AS 'QTD FUNCIONARIOS' FROM FUNCIONARIOS;
	...
	WHERE DEPARTAMENTO = 'Roupas' /* MAIOR PROBABILIDADE, MELHOR A PERFORMANCE DO OR */
	OR DEPARTAMENTO = 'Filmes';

	--Como estamos trabalhando com OR e a segunda condicao é opcional
	--Colocamos na primeira condicao quem tem mais chhances de uma saida
	--Verdadeira, pois a segunda condicao nao sera checada nesse caso.

	SELECT COUNT(*) AS 'QTD DEP LAR OU FILMES'FROM FUNCIONARIOS
	WHERE DEPARTAMENTO = 'Lar' OR DEPARTAMENTO = 'Filmes';

	SELECT COUNT(*) AS 'QTD FUNC FEMININO' FROM FUNCIONARIOS
	WHERE SEXO = 'Feminino';

	--491 Mulheres
	SELECT COUNT(*) AS 'QTD SEXO FUNCIONARIOS', SEXO FROM FUNCIONARIOS
	GROUP BY SEXO;

	SELECT SEXO, COUNT(*) AS 'QTD SEXO FUNCIONARIOS' FROM FUNCIONARIOS
	GROUP BY SEXO;

	--52 Lar | 21 Filmes
	SELECT COUNT(*) AS 'QTD DEPART', DEPARTAMENTO
	FROM FUNCIONARIOS
	GROUP BY DEPARTAMENTO;   

	SELECT * FROM FUNCIONARIOS
	WHERE SEXO = 'FEMININO'
	AND DEPARTAMENTO = 'LAR'; /*32*/

	SELECT * FROM FUNCIONARIOS
	WHERE SEXO = 'FEMININO'
	AND DEPARTAMENTO = 'FILMES'; /*9*/

	SELECT NOME, EMAIL, SEXO, DEPARTAMENTO FROM FUNCIONARIOS
	WHERE (DEPARTAMENTO = 'Lar' AND SEXO = 'Feminino') /* MAIOR PROBABILIDADE, MELHOR A PERFORMANCE DO OR */
	OR (DEPARTAMENTO = 'Filmes' AND SEXO = 'Feminino');

	SELECT NOME, EMAIL, SEXO, DEPARTAMENTO FROM FUNCIONARIOS /* MENOR PROBABILIDADE, MELHOR A PERFORMANCE DO OR */
	WHERE (DEPARTAMENTO = 'Lar' OR DEPARTAMENTO = 'Filmes')
	AND SEXO = 'Feminino';    

	--Como estamos trabalhando com AND e a segunda condicao é obrigatoria
	--Colocamos na primeira condicao quem tem menos chances de uma saida
	--Verdadeira, pois a segunda condicao sera obrigatoriamente checada.

	SELECT SEXO, COUNT(*) AS 'QTD' FROM FUNCIONARIOS 
	GROUP BY SEXO;

	SELECT NOME, DEPARTAMENTO, SEXO FROM FUNCIONARIOS
	WHERE SEXO = 'Masculino' /* MAIOR PROBABILIDADE, MELHOR A PERFORMANCE DO OR */
	OR DEPARTAMENTO = 'Jardim';

	SELECT NOME, DEPARTAMENTO, SEXO FROM FUNCIONARIOS
	WHERE DEPARTAMENTO = 'Jardim' /* MENOR PROBABILIDADE, MELHOR PERFORMANCE POIS IRA CHECAR A SEGUNDA CONDICAO UM NUMERO MENOR DE VEZES*/
	AND SEXO = 'Masculino';

	SELECT NOME, DEPARTAMENTO, SEXO FROM FUNCIONARIOS
	WHERE DEPARTAMENTO = 'Jardim' /* MENOR PROBABILIDADE, MELHOR PERFORMANCE */
	AND SEXO = 'Feminino';
